...
pub mod hints {
    ...
    // 0x7e90_0000: dedicated to cxx/list_node_pool_insert_refcounted's
    // target-width list, node, and payload fixture; mappings never unmap.
    pub const LIST_NODE_POOL_INSERT_REFCOUNTED: usize = 0x7e90_0000;
    ...
    // 0x8400_0000: dedicated to cxx/signed_key_tree_find's raw-u32 tree
    // fixture for FUN_083dbab4; mappings never unmap, so no other user may
    // share this hint.
    pub const SIGNED_KEY_TREE_LOWER_BOUND: usize = 0x8400_0000;
    ...
    // 0x3700_0000: dedicated to cxx/red_black_tree_word_subtree_clone's
    // target-width source and cloned-tree fixture; mappings never unmap, so
    // no other user may share this hint.
    pub const RED_BLACK_TREE_WORD_SUBTREE_CLONE: usize = 0x3700_0000;
    ...
    // 0x76a0_0000: dedicated to cxx/list_member_destroy's target-width object,
    // list-header, and first-node fixture; mappings never unmap.
    pub const CXX_LIST_MEMBER_DESTROY: usize = 0x76a0_0000;
