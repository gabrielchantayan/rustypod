//! Filesystem/disk cache lock release.
//!
...
//! the decrypted image). The wait sibling acquires the same id through the
//! rom_sem_wait veneer; this module ports the release half.
...
/// the unported wait sibling @ `0x082d7924` (same global, rom_sem_wait
/// veneer); the rest sit in the cache descriptor family 0x082dfe68..0x082e2fc8
