...
/// copy_word_range_if_destination_loop_entry_9188 — retailOS
/// `thunk_FUN_083e91a0` @ **0x083e9188** (**4 bytes exactly**,
/// `0x083e9188..0x083e918c`). Raw firmware is `b 0x083e91a0`, entering the
/// loop test of the separately entered 32-byte transfer body at
/// `0x083e918c..0x083e91ac`; the next real function boundary is `0x083e91b0`.
...
#[inline(never)]
pub unsafe extern "C" fn copy_word_range_if_destination_loop_entry_9188(
    mut source: *const u32,
    end: *const u32,
    mut destination: *mut u32,
) -> *mut u32 {
    core::arch::asm!("/* copy_word_range_if_destination_loop_entry_9188 */", options(nostack, preserves_flags));
    while source != end {
...
mod tests {
    ...
    use super::copy_word_range_if_destination_loop_entry_9188;
    ...
    fn copies_empty_and_nonempty_ranges_and_returns_cursor() {
        ...
        let empty_result = unsafe {
            copy_word_range_if_destination_loop_entry_9188(
                source.as_ptr(),
                source.as_ptr(),
