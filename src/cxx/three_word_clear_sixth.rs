//! `three_word_clear_sixth` — original: `FUN_083e41fc` @ 0x083e41fc (20 bytes).
//!
//! Source: `ipod-decomp/decomp/c/038/083e41fc_FUN_083e41fc.c`.
//!
...
#[cfg_attr(target_os = "none", link_section = ".text.three_word_clear_sixth")]
#[inline(never)]
pub unsafe extern "C" fn three_word_clear_sixth(target: *mut u32) {
    unsafe {
        target.write(0);
...
mod tests {
    ...
    fn clears_the_three_target_words_without_touching_surrounding_bytes() {
        ...
        unsafe { three_word_clear_sixth(words.as_mut_ptr().add(1)) };
