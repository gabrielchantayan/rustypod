...
/// equal_deref — originals: `FUN_083cf908` @ 0x083cf908,
/// `FUN_083cf950` @ 0x083cf950, `FUN_083cf968` @ 0x083cf968, and
/// `FUN_083cf980` @ 0x083cf980 (24 bytes each). Raw bytes show all four are
/// the same six-word leaf. Decoding every ARM B/BL word in `osos.dec` finds 8
/// plain `bl` callers at 0x083cf908 (0x081bea64, 0x0839bca8, 0x083c9a14,
...
mod tests {
    ...
    #[test]
    fn equal_deref_f908_f950_f968_f980_copies_compare_words_by_value() {
        unsafe {
            let one: u32 = 1;
            let other_one: u32 = 1;
            let two: u32 = 2;
