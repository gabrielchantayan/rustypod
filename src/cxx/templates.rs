...
/// 0x083cf920, 0x083cf950, and 0x083cf980 copies have the same raw body and
/// ABI, so their ledger entries deliberately hook this established export
/// instead of introducing redundant dispatch seams.
///
