//! `three_word_clear_seventh` — original: `FUN_083e472c` @ 0x083e472c (20 bytes).
//!
//! Source: `ipod-decomp/decomp/c/038/083e472c_FUN_083e472c.c`.
//!
...
#[cfg_attr(target_os = "none", link_section = ".text.three_word_clear_seventh")]
#[inline(never)]
pub unsafe extern "C" fn three_word_clear_seventh(target: *mut u32) {
    unsafe {
        target.write(0);
...
mod tests {
    ...
    fn clears_the_three_target_words_without_touching_surrounding_bytes() {
        ...
        unsafe { three_word_clear_seventh(words.as_mut_ptr().add(1)) };
