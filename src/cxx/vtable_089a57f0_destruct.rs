//! Destructor for the otherwise unidentified vtable `0x089a57f0` class.
//!
//! `vtable_089a57f0_destruct` — original: `FUN_083d1fd0` @ `0x083d1fd0`.
//!
//! **56 bytes**, `0x083d1fd0..0x083d2008`: 52 instruction bytes followed by
//! the vtable literal `0x089a57f0` at `0x083d2008`; the next real function
//! starts at `0x083d200c`. Decoding every ARM immediate branch in `osos.dec`
//! finds **3 plain `bl` callers** (0x0826b760, 0x0827759c, 0x082775cc) and
...
//! `0x083d1f40` base cleanup, then tail-chain to the ported observable-array
...
//! seam calls its fixed `0x083d1f40` address. Host tests replace both with
...
/// Literal installed by the destructor at `0x083d2008`.
pub const VTABLE_089A57F0: u32 = 0x089a_57f0;

/// Observable-array base plus the only two derived words touched here.
#[repr(C)]
pub struct Vtable089a57f0Object {
    pub array: ObservableArray,
    pub unknown_word_at_10: u32,
    pub payload: u32,
}

const _: [u8; 0x14] = [0; core::mem::offset_of!(Vtable089a57f0Object, payload)];
const _: [u8; 0x18] = [0; core::mem::size_of::<Vtable089a57f0Object>()];

type PayloadRelease = unsafe extern "C" fn(u32);
type BaseCleanup = unsafe extern "C" fn(*mut Vtable089a57f0Object);

/// Direct-call seam for unported `FUN_083d1f40` @ `0x083d1f40`.
pub static mut VTABLE_089A57F0_BASE_CLEANUP: BaseCleanup = vtable_089a57f0_base_cleanup_unported;

#[cfg(target_arch = "arm")]
unsafe extern "C" fn vtable_089a57f0_base_cleanup_unported(this: *mut Vtable089a57f0Object) {
    let cleanup: BaseCleanup = core::mem::transmute(0x083d_1f40usize);
    cleanup(this);
}

#[cfg(not(target_arch = "arm"))]
unsafe extern "C" fn vtable_089a57f0_base_cleanup_unported(_this: *mut Vtable089a57f0Object) {}

/// Host-model seam for the payload's target-vtable slot `+0x1c`.
#[cfg(not(target_arch = "arm"))]
pub static mut VTABLE_089A57F0_PAYLOAD_RELEASE: PayloadRelease = vtable_089a57f0_payload_release_unported;

unsafe extern "C" fn vtable_089a57f0_payload_release_unported(_payload: u32) {}

/// Destroys the observed derived observable-array object and returns `this`.
///
/// # Safety
///
/// `this` must reference a writable, target-layout [`Vtable089a57f0Object`].
/// A nonzero `payload` must satisfy its vtable release contract on ARM.
#[inline(never)]
#[cfg_attr(target_os = "none", no_mangle)]
pub unsafe extern "C" fn vtable_089a57f0_destruct(
    this: *mut Vtable089a57f0Object,
) -> *mut Vtable089a57f0Object {
    core::ptr::addr_of_mut!((*this).array.base.vtable).write_volatile(VTABLE_089A57F0);
    ...
    if payload != 0 {
        ...
        #[cfg(not(target_arch = "arm"))]
        {
            let release = core::ptr::read_volatile(core::ptr::addr_of!(VTABLE_089A57F0_PAYLOAD_RELEASE));
            release(payload);
        }
    }

    let base_cleanup = core::ptr::read_volatile(core::ptr::addr_of!(VTABLE_089A57F0_BASE_CLEANUP));
    base_cleanup(this);
...
mod tests {
    ...
    unsafe extern "C" fn record_base(this: *mut Vtable089a57f0Object) {
    ...
    impl SeamGuard {
        unsafe fn install() -> Self {
            let base = core::ptr::addr_of!(VTABLE_089A57F0_BASE_CLEANUP).read();
            let payload = core::ptr::addr_of!(VTABLE_089A57F0_PAYLOAD_RELEASE).read();
            let notify = core::ptr::addr_of!(super::super::observable_array::OBSERVABLE_ARRAY_NOTIFY).read();
            core::ptr::addr_of_mut!(VTABLE_089A57F0_BASE_CLEANUP).write(record_base);
            core::ptr::addr_of_mut!(VTABLE_089A57F0_PAYLOAD_RELEASE).write(record_payload);
    ...
    impl Drop for SeamGuard {
        fn drop(&mut self) {
            unsafe {
                core::ptr::addr_of_mut!(VTABLE_089A57F0_BASE_CLEANUP).write(self.base);
                core::ptr::addr_of_mut!(VTABLE_089A57F0_PAYLOAD_RELEASE).write(self.payload);
                core::ptr::addr_of_mut!(super::super::observable_array::OBSERVABLE_ARRAY_NOTIFY).write(self.notify);
            }
        }
    }

    fn object(payload: u32) -> Vtable089a57f0Object {
        Vtable089a57f0Object {
    ...
    fn releases_nonnull_payload_then_cleans_base_and_destructs_array() {
        ...
        let returned = unsafe { vtable_089a57f0_destruct(this) };
    ...
    fn null_payload_skips_virtual_release_but_runs_both_base_teardowns() {
        ...
        unsafe { vtable_089a57f0_destruct(this) };
