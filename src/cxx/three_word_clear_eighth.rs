//! `three_word_clear_eighth` — original: `FUN_083e4a7c` @ 0x083e4a7c (20 bytes).
//!
//! Source: `ipod-decomp/decomp/c/038/083e4a7c_FUN_083e4a7c.c`.
//!
...
#[cfg_attr(target_os = "none", link_section = ".text.three_word_clear_eighth")]
#[inline(never)]
pub unsafe extern "C" fn three_word_clear_eighth(target: *mut u32) {
    unsafe {
        target.write(0);
...
mod tests {
    ...
    fn clears_the_three_target_words_without_touching_surrounding_bytes() {
        ...
        unsafe { three_word_clear_eighth(words.as_mut_ptr().add(1)) };
