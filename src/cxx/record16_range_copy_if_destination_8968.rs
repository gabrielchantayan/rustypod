...
//! `FUN_083e8968` at load address `0x083e8968` (52 bytes).
//!
//! Raw `osos.dec` establishes the exact extent `0x083e8968..0x083e899b`:
...
//! `0x083e899c`. Full-image A32 decoding finds zero inbound plain direct `bl`
//! calls, zero inbound predicated direct `bl` calls, and no body calls.
//!
...
#[cfg_attr(target_os = "none", link_section = ".text.record16_range_copy_if_destination_8968")]
#[inline(never)]
pub unsafe extern "C" fn record16_range_copy_if_destination_8968(
...
mod tests {
    ...
    use super::record16_range_copy_if_destination_8968;
    ...
    fn copies_complete_records_and_returns_advanced_destination() {
        ...
        let result = unsafe {
            record16_range_copy_if_destination_8968(source.as_ptr(), end, destination.as_mut_ptr())
        };
    ...
    fn leaves_destination_unchanged_for_an_empty_range() {
        ...
        let result = unsafe {
            record16_range_copy_if_destination_8968(source.as_ptr(), source.as_ptr(), destination.as_mut_ptr())
        };
    ...
    fn null_destination_advances_without_reading_source() {
        let result = unsafe {
            record16_range_copy_if_destination_8968(
                core::ptr::null(),
    ...
    fn preserves_grouped_forward_overlap() {
        ...
        unsafe {
            record16_range_copy_if_destination_8968(source, end, words.as_mut_ptr().add(4));
        }
